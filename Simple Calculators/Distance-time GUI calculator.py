...
if __name__ == "__main__":
    ...
    button1 = Button(root, text="CLEAR", bg="light green",
    ...
    button5 = Button(root, text="Train", fg="black", bg="pink", command=train)

    # Create a Driving Button and attached to driving function
    button6 = Button(root, text="Driving", fg="black", bg="pink", command=driving)

    # Create a Walking Button and attached to walking function
    button7 = Button(root, text="Walking", fg="black", bg="pink", command=walking)
    ...
    root.title('Distance-Time Calculator')
    # Start the GUI
    root.mainloop()
